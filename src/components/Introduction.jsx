...
export function Introduction() {
  return (
    <div
      style={{ marginTop: "50px", marginRight: "310px", marginLeft: "200px" }}
    >
      <FadeIn transitionDuration="1100">
        <MDBJumbotron
          ...
          className="z-depth-4"
          style={{
            /*backgroundColor: '#748F9A',*/ background:
              "linear-gradient(110deg, #748F9A 60%, #3C9E99 60%)",
            minWidth: "250px",
            border: "1px black",
            borderRadius: "9px",
          }}
